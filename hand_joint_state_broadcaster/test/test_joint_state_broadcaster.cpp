...
#include "test_hand_joint_state_broadcaster.hpp"
...
void JointStateBroadcasterTest::init_broadcaster_and_set_parameters(
  const std::vector<std::string> & joint_names, const std::vector<std::string> & interfaces)
{
  const auto result = state_broadcaster_->init("hand_joint_state_broadcaster");
...
TEST_F(JointStateBroadcasterTest, JointStatePublishTestLocalTopic)
{
  ...
  test_published_joint_state_message("hand_joint_state_broadcaster/joint_states");
}
...
TEST_F(JointStateBroadcasterTest, DynamicJointStatePublishTestLocalTopic)
{
  ...
  test_published_dynamic_joint_state_message("hand_joint_state_broadcaster/dynamic_joint_states");
}
