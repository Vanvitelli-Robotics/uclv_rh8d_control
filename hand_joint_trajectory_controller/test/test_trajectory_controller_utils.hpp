...
#include "hand_joint_trajectory_controller/tolerances.hpp"
...
[[maybe_unused]] void expectDefaultTolerances(
  hand_joint_trajectory_controller::SegmentTolerances active_tolerances)
{
...
{
class TestableHandJointTrajectoryController
: public hand_joint_trajectory_controller::HandJointTrajectoryController
{
public:
  using hand_joint_trajectory_controller::HandJointTrajectoryController::HandJointTrajectoryController;
  using hand_joint_trajectory_controller::HandJointTrajectoryController::validate_trajectory_msg;

  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = hand_joint_trajectory_controller::HandJointTrajectoryController::on_configure(previous_state);
    return ret;
  }
  ...
  hand_joint_trajectory_controller::SegmentTolerances get_active_tolerances()
  {
  ...
  hand_joint_trajectory_controller::SegmentTolerances get_tolerances() const
  {
...
public:
  ...
  virtual void SetUp()
  {
    controller_name_ = "test_hand_joint_trajectory_controller";
  ...
  {
    traj_controller_ = std::make_shared<TestableHandJointTrajectoryController>();
  ...
  void subscribeToStateLegacy()
  {
    ...
    using control_msgs::msg::HandJointTrajectoryControllerState;
    ...
    state_legacy_subscriber_ =
      traj_lifecycle_node->create_subscription<HandJointTrajectoryControllerState>(
        controller_name_ + "/state", qos,
        [&](std::shared_ptr<HandJointTrajectoryControllerState> msg)
        {
  ...
  void subscribeToState(rclcpp::Executor & executor)
  {
    ...
    // I do not understand why spin_some provides only one message
    qos.keep_last(1);
    state_subscriber_ = traj_lifecycle_node->create_subscription<HandJointTrajectoryControllerState>(
  ...
  std::shared_ptr<control_msgs::msg::HandJointTrajectoryControllerState> getStateLegacy() const
  {
    std::lock_guard<std::mutex> guard(state_legacy_mutex_);
    return state_legacy_msg_;
  }
  std::shared_ptr<control_msgs::msg::HandJointTrajectoryControllerState> getState() const
  {
    std::lock_guard<std::mutex> guard(state_mutex_);
    return state_msg_;
  }
  ...
  std::shared_ptr<TestableHandJointTrajectoryController> traj_controller_;
  rclcpp::Subscription<control_msgs::msg::HandJointTrajectoryControllerState>::SharedPtr
    state_subscriber_;
  mutable std::mutex state_mutex_;
  std::shared_ptr<control_msgs::msg::HandJointTrajectoryControllerState> state_msg_;
  rclcpp::Subscription<control_msgs::msg::HandJointTrajectoryControllerState>::SharedPtr
    state_legacy_subscriber_;
  mutable std::mutex state_legacy_mutex_;
  std::shared_ptr<control_msgs::msg::HandJointTrajectoryControllerState> state_legacy_msg_;
