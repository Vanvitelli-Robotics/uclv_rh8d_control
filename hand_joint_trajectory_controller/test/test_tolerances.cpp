...
using hand_joint_trajectory_controller::SegmentTolerances;
...
protected:
  ...
  hand_joint_trajectory_controller::Params params;
...
TEST_F(TestTolerancesFixture, test_get_segment_tolerances)
{
  ...
  auto active_tolerances = hand_joint_trajectory_controller::get_segment_tolerances(
