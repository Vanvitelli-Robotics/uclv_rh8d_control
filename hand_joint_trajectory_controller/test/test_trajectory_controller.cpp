...
void TrajectoryControllerTest::test_state_publish_rate_target(int target_msg_count)
{
  ...
  rclcpp::Subscription<HandJointTrajectoryControllerState>::SharedPtr subs =
    traj_controller_->get_node()->create_subscription<HandJointTrajectoryControllerState>(
      controller_name_ + "/state", qos_level,
      [&](HandJointTrajectoryControllerState::UniquePtr) { ++echo_received_counter; });
...
TEST_P(TrajectoryControllerTestParameterized, test_execute_partial_traj_in_future)
{
  ...
  // hand_joint_trajectory_controller/include/hand_joint_trajectory_controller/init_joint_trajectory.h#L149
  return;
