...
#include "hand_joint_trajectory_controller/interpolation_methods.hpp"
#include "hand_joint_trajectory_controller/tolerances.hpp"
#include "hand_joint_trajectory_controller/trajectory.hpp"
#include "hand_joint_trajectory_controller/visibility_control.h"
...
#include "hand_joint_trajectory_controller_parameters.hpp"
...
class HandJointTrajectoryController : public controller_interface::ControllerInterface
{
public:
  JOINT_TRAJECTORY_CONTROLLER_PUBLIC
  HandJointTrajectoryController();
...
protected:
  ...
  // Parameters from ROS for hand_joint_trajectory_controller
  ...
  // custom method
  double radToMotorPosition(double &value,double in_min, double in_max, double out_min, double out_max); 
