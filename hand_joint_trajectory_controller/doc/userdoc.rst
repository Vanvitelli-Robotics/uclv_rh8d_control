:github_url: https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/hand_joint_trajectory_controller/doc/userdoc.rst

.. _hand_joint_trajectory_controller_userdoc:
...
When an active action goal is preempted by another command coming from the action interface, the goal is canceled and the client is notified. The trajectory is replaced in a defined way, see :ref:`trajectory replacement <hand_joint_trajectory_controller_trajectory_replacement>`.
...
<controller_name>/controller_state [control_msgs::msg::HandJointTrajectoryControllerState]
...
.. toctree::
   ...
   hand_joint_trajectory_controller Parameters <parameters.rst>
   rqt_hand_joint_trajectory_controller <../../rqt_hand_joint_trajectory_controller/doc/userdoc.rst>


.. rubric:: Footnote

.. [#f1] Adolfo Rodriguez: `hand_joint_trajectory_controller <http://wiki.ros.org/hand_joint_trajectory_controller>`_
