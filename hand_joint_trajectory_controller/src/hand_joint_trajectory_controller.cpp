...
#include "hand_joint_trajectory_controller/hand_joint_trajectory_controller.hpp"
...
#include "hand_joint_trajectory_controller/trajectory.hpp"
...
namespace hand_joint_trajectory_controller
{
  HandJointTrajectoryController::HandJointTrajectoryController()
      : controller_interface::ControllerInterface(), dof_(0)
  {
  }

  double HandJointTrajectoryController::radToMotorPosition(double &value, double in_min, double in_max, double out_min, double out_max)
  {
    if (value < in_min)
    {
      return out_min;
  ...
  controller_interface::CallbackReturn HandJointTrajectoryController::on_init()
  {
    try
    {
  ...
  HandJointTrajectoryController::command_interface_configuration() const
  {
  ...
  controller_interface::InterfaceConfiguration
  HandJointTrajectoryController::state_interface_configuration() const
  {
    controller_interface::InterfaceConfiguration conf;
    conf.type = controller_interface::interface_configuration_type::INDIVIDUAL;
  ...
  controller_interface::return_type HandJointTrajectoryController::update(
    ...
    if (has_active_trajectory())
    {
      ...
      if (valid_point)
      {
        ...
        if (!tolerance_violated_while_moving && within_goal_time)
        {
          ...
          {
            if (state_desired_.positions[i] <= M_PI_4)
            {
              first_time = false;
              break;
            }
          ...
          for(size_t i = 0; i < state_desired_.positions.size(); i++)
          {
            if (params_.joints[0] == "forearm:1--base:1" && i == 0)
            state_desired_.positions[i] = static_cast<float>(radToMotorPosition(state_desired_.positions[0], -M_PI_2, M_PI_2, 0.0, 4095.0));
            else
            state_desired_.positions[i] = static_cast<float>(radToMotorPosition(state_desired_.positions[0], -M_PI_4, M_PI_4, 0.0, 4095.0));
          }

          // set values for next hardware write()
          if (has_position_command_interface_ && !first_time)
          {
  ...
  void HandJointTrajectoryController::read_state_from_state_interfaces(JointTrajectoryPoint &state)
  {
  ...
  bool HandJointTrajectoryController::read_state_from_command_interfaces(JointTrajectoryPoint &state)
  {
  ...
  bool HandJointTrajectoryController::read_commands_from_command_interfaces(
  ...
  void HandJointTrajectoryController::query_state_service(
  ...
  controller_interface::CallbackReturn HandJointTrajectoryController::on_configure(
      const rclcpp_lifecycle::State &)
  {
    ...
    joint_command_subscriber_ =
        get_node()->create_subscription<trajectory_msgs::msg::JointTrajectory>(
            ...
            std::bind(&HandJointTrajectoryController::topic_callback, this, std::placeholders::_1));
    ...
    action_server_ = rclcpp_action::create_server<FollowJTrajAction>(
        ...
        std::bind(&HandJointTrajectoryController::goal_received_callback, this, _1, _2),
        std::bind(&HandJointTrajectoryController::goal_cancelled_callback, this, _1),
        std::bind(&HandJointTrajectoryController::goal_accepted_callback, this, _1));
    ...
    query_state_srv_ = get_node()->create_service<control_msgs::srv::QueryTrajectoryState>(
        ...
        std::bind(&HandJointTrajectoryController::query_state_service, this, _1, _2));

    return CallbackReturn::SUCCESS;
  }

  controller_interface::CallbackReturn HandJointTrajectoryController::on_activate(
      const rclcpp_lifecycle::State &)
  {
    auto logger = get_node()->get_logger();
  ...
  controller_interface::CallbackReturn HandJointTrajectoryController::on_deactivate(
      const rclcpp_lifecycle::State &)
  {
  ...
  controller_interface::CallbackReturn HandJointTrajectoryController::on_cleanup(
      const rclcpp_lifecycle::State &)
  {
    return CallbackReturn::SUCCESS;
  }

  controller_interface::CallbackReturn HandJointTrajectoryController::on_error(
      const rclcpp_lifecycle::State &)
  {
    if (!reset())
    {
  ...
  bool HandJointTrajectoryController::reset()
  {
    subscriber_is_active_ = false;
  ...
  controller_interface::CallbackReturn HandJointTrajectoryController::on_shutdown(
      const rclcpp_lifecycle::State &)
  {
  ...
  void HandJointTrajectoryController::publish_state(
  ...
  void HandJointTrajectoryController::topic_callback(
      const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> msg)
  {
    ...
    // http://wiki.ros.org/hand_joint_trajectory_controller/UnderstandingTrajectoryReplacement
  ...
  rclcpp_action::GoalResponse HandJointTrajectoryController::goal_received_callback(
  ...
  rclcpp_action::CancelResponse HandJointTrajectoryController::goal_cancelled_callback(
  ...
  void HandJointTrajectoryController::goal_accepted_callback(
  ...
  void HandJointTrajectoryController::fill_partial_goal(
  ...
  void HandJointTrajectoryController::sort_to_local_joint_order(
  ...
  bool HandJointTrajectoryController::validate_trajectory_point_field(
  ...
  bool HandJointTrajectoryController::validate_trajectory_msg(
  ...
  void HandJointTrajectoryController::add_new_trajectory_msg(
      const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> &traj_msg)
  {
    traj_msg_external_point_ptr_.writeFromNonRT(traj_msg);
  }

  void HandJointTrajectoryController::preempt_active_goal()
  {
    const auto active_goal = *rt_active_goal_.readFromNonRT();
    if (active_goal)
    {
  ...
  std::shared_ptr<trajectory_msgs::msg::JointTrajectory>
  HandJointTrajectoryController::set_hold_position()
  {
  ...
  std::shared_ptr<trajectory_msgs::msg::JointTrajectory>
  HandJointTrajectoryController::set_success_trajectory_point()
  {
  ...
  bool HandJointTrajectoryController::contains_interface_type(
  ...
  void HandJointTrajectoryController::resize_joint_trajectory_point(
  ...
  void HandJointTrajectoryController::resize_joint_trajectory_point_command(
      trajectory_msgs::msg::JointTrajectoryPoint &point, size_t size)
  {
    if (has_position_command_interface_)
    {
  ...
  bool HandJointTrajectoryController::has_active_trajectory() const
  {
    return traj_external_point_ptr_ != nullptr && traj_external_point_ptr_->has_trajectory_msg();
  }

  void HandJointTrajectoryController::update_pids()
  {
    for (size_t i = 0; i < dof_; ++i)
    {
      const auto &gains = params_.gains.joints_map.at(params_.joints[i]);
  ...
  void HandJointTrajectoryController::init_hold_position_msg()
  {
...
PLUGINLIB_EXPORT_CLASS(
    hand_joint_trajectory_controller::HandJointTrajectoryController, controller_interface::ControllerInterface)
